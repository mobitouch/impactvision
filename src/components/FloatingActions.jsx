  ...
  return (
    <div className="fixed bottom-6 right-6 z-[1000] flex flex-col gap-3">
      ...
      <button
        ...
        className={`flex h-12 w-12 items-center justify-center rounded-full bg-navy border border-white/20 text-white shadow-lg backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:bg-accent hover:text-navy hover:border-transparent ${showScroll ? "scale-100 opacity-100" : "scale-0 opacity-0 pointer-events-none"
          }`}
      >
        <ArrowUp size={24} />
      </button>
